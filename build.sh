...
docker pull nellokudo/wine-builder:steamrt4-190426 || { echo "docker pull failed" && exit 1; }
docker tag nellokudo/wine-builder:steamrt4-190426 wine-builder:latest
