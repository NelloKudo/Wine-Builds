...
docker pull nellokudo/wine-builder:steamrt4-040526 || { echo "docker pull failed" && exit 1; }
docker tag nellokudo/wine-builder:steamrt4-040526 wine-builder:latest
